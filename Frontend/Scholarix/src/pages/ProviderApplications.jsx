    ...
    <div className="pd-page">
      ...
      <section className="pd-section" style={{ maxWidth: "1400px", margin: "0 auto 32px auto" }}>
        ...
        {Object.keys(groupedApps).length > 0 ? (
              ...
              <div className="pd-scholarship-group-body">
                {group.apps.map(app => (
                  <div key={app.application_id} className="pd-applicant-card">
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", gap: "10px", marginBottom: "12px", fontSize: "13px", color: "var(--pd-text-muted)", background: "rgba(0,0,0,0.2)", padding: "10px", borderRadius: "8px" }}>
                    ...
                    {app.essay && (
                      <div className="pd-app-essay" style={{ marginBottom: "12px", fontSize: "13px" }}>
                        ...
                        <p style={{ marginTop: "4px", color: "var(--pd-text-dim)", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
                          {app.essay}
                        </p>
                      </div>
                    )}
          ...
          <div style={{ textAlign: "center", padding: "40px 20px", background: "var(--pd-bg)", border: "1px solid var(--pd-border)", borderRadius: "12px" }}>
            ...
            <div className="pd-modal-header">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <button
                  ...
                  style={{ background: "none", border: "none", color: "var(--pd-text-muted)", fontSize: "20px", cursor: "pointer" }}
                >
                  ✕
                </button>
              </div>
