...
export default function ScholarshipDetails() {
  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', background: 'var(--color-bg)', color: 'var(--color-text)' }}>
  ...
  if (!scholarship) {
    return (
      <div style={{ padding: "60px 20px", textAlign: "center", background: "var(--color-bg)", minHeight: "100vh", color: "var(--color-text)" }}>
        <h2>Scholarship Not Found</h2>
        <p style={{ color: "var(--color-text-muted)", marginTop: "8px" }}>The opportunity you are looking for may have been removed.</p>
        <button
  ...
  return (
    <div style={{ background: "var(--color-bg)", minHeight: "100vh", color: "var(--color-text)", paddingBottom: "60px" }}>
      ...
      <main style={{ maxWidth: "1300px", margin: "32px auto", padding: "0 24px" }}>
        {/* Banner Card */}
        <div style={{ background: "linear-gradient(135deg, var(--color-surface) 0%, var(--color-bg) 100%)", border: "1px solid var(--color-border)", borderRadius: "16px", padding: "32px", marginBottom: "24px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "16px" }}>
            <div>
              ...
              <h1 style={{ fontSize: "28px", fontWeight: "800", marginTop: "12px", marginBottom: "8px", color: "var(--color-text)" }}>
                {scholarship.name}
              </h1>
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div style={{ fontSize: "13px", color: "var(--color-text-muted)" }}>Award Value</div>
            </div>
          </div>

          {/* Action Button */}
          <div style={{ marginTop: "28px", paddingTop: "20px", borderTop: "1px solid var(--color-border)", display: "flex", justifyContent: "flex-end" }}>
            {isApplied ? (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            ...
            <div style={{ background: "var(--color-surface)", border: "1px solid var(--color-border)", borderRadius: "12px", padding: "24px" }}>
              ...
              <p style={{ color: "var(--color-text-dim)", fontSize: "15px", lineHeight: "1.7", whiteSpace: "pre-line" }}>
          ...
          <div>
            <div style={{ background: "var(--color-surface)", border: "1px solid var(--color-border)", borderRadius: "12px", padding: "24px", position: "sticky", top: "24px" }}>
              <h3 style={{ fontSize: "16px", fontWeight: "700", color: "var(--color-text)", marginBottom: "16px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px", fontSize: "14px", borderTop: "1px solid var(--color-border)", paddingTop: "16px" }}>
                {scholarship.website && (
                  <div>
                    <span style={{ color: "var(--color-text-muted)", fontSize: "12px", display: "block" }}>Website</span>
                    <a
                ...
                {scholarship.contact_name && (
                  <div>
                    <span style={{ color: "var(--color-text-muted)", fontSize: "12px", display: "block" }}>Contact Representative</span>
                    <span style={{ color: "var(--color-text)" }}>{scholarship.contact_name} {scholarship.contact_title ? `(${scholarship.contact_title})` : ""}</span>
                  </div>
                )}

                {scholarship.provider_email && (
                  <div>
                    <span style={{ color: "var(--color-text-muted)", fontSize: "12px", display: "block" }}>Contact Email</span>
                    <span style={{ color: "var(--color-text)" }}>✉ {scholarship.provider_email}</span>
                  </div>
                )}
