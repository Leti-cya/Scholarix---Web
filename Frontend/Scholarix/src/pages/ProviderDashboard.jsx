...
export default function ProviderDashboard() {
  ...
  const [provider, setProvider] = useState({ orgName: "Provider Org", contactName: "", isVerified: true });
      ...
      {!provider.isVerified && (
        <div
          ...
          style={{
            ...
            background: 'var(--pd-warning-bg)', border: '1px solid var(--pd-warning-border)', borderLeft: '5px solid #F5C842',
            borderRadius: '12px', padding: '14px 20px', marginBottom: '24px'
          }}
        >
          <span style={{ color: 'var(--pd-warning-text)', fontSize: '0.9rem', fontWeight: 600 }}>
            📩 Please verify your email address to secure your organisation account.
          </span>
          <button
            className="pd-btn pd-btn-primary"
            style={{ background: '#D97706', color: '#fff', padding: '8px 16px', fontSize: '0.82rem' }}
                ...
                {recentApps.map((app) => (
                  <div key={app.application_id} className="pd-applicant-card" style={{ marginBottom: "14px" }}>
                    <div className="pd-app-student-info" style={{ marginBottom: "10px", borderBottom: "1px solid var(--pd-border)", paddingBottom: "8px" }}>
                      <div>
                        <strong style={{ fontSize: "16px", color: "var(--pd-text-main)" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: "8px", marginBottom: "16px", fontSize: "13px", color: "var(--pd-text-muted)" }}>
              ...
              <ul className="pd-list">
                {scholarships.map((s) => (
                  <li key={s.id} className="pd-item">
                    ...
                    <p style={{ fontSize: "13.5px", color: "var(--pd-text-dim)", marginTop: "12px", lineHeight: "1.4" }}>
                      {s.description}
                    </p>
          ...
          <div style={{
            ...
            <form onSubmit={handleSaveOrgProfile}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                <div>
                  <label style={{ display: "block", fontSize: "13px", fontWeight: "600", color: "var(--pd-text-dim)", marginBottom: "6px" }}>Organization Name</label>
                  <input
                    type="text"
                    className="pd-input"
                ...
                <div>
                  <label style={{ display: "block", fontSize: "13px", fontWeight: "600", color: "var(--pd-text-dim)", marginBottom: "6px" }}>Organization Type</label>
                  <input
                    type="text"
                    className="pd-input"
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                <div>
                  <label style={{ display: "block", fontSize: "13px", fontWeight: "600", color: "var(--pd-text-dim)", marginBottom: "6px" }}>Website URL</label>
                  <input
                    type="text"
                    className="pd-input"
                ...
                <div>
                  <label style={{ display: "block", fontSize: "13px", fontWeight: "600", color: "var(--pd-text-dim)", marginBottom: "6px" }}>Registration No.</label>
                  <input
                    type="text"
                    className="pd-input"
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                <div>
                  <label style={{ display: "block", fontSize: "13px", fontWeight: "600", color: "var(--pd-text-dim)", marginBottom: "6px" }}>Contact Person Name</label>
                  <input
                    type="text"
                    className="pd-input"
                ...
                <div>
                  <label style={{ display: "block", fontSize: "13px", fontWeight: "600", color: "var(--pd-text-dim)", marginBottom: "6px" }}>Contact Job Title</label>
                  <input
                    type="text"
                    className="pd-input"
              ...
              <div style={{ marginBottom: "24px" }}>
                <label style={{ display: "block", fontSize: "13px", fontWeight: "600", color: "var(--pd-text-dim)", marginBottom: "6px" }}>About Organization</label>
                <textarea
                  rows={4}
                  className="pd-input"
              ...
              <div style={{ display: "flex", justifyContent: "flex-end", gap: "12px" }}>
                <button
                  type="button"
                  onClick={() => setEditOrgProfileModal(false)}
                  style={{ padding: "10px 18px", borderRadius: "8px", background: "transparent", border: "1px solid var(--pd-border-strong)", color: "var(--pd-text-dim)", fontWeight: "600", cursor: "pointer" }}
                >
                  Cancel
                </button>
                <button
            ...
            <div className="pd-modal-body">
              ...
              <div>
                ...
                <div className="pd-app-essay" style={{ margin: 0, maxHeight: "200px", overflowY: "auto" }}>
                  <p style={{ margin: 0, whiteSpace: "pre-line", lineHeight: "1.6", color: "var(--pd-text-dim)" }}>
              ...
              <div style={{ background: "var(--pd-bg)", padding: "16px", borderRadius: "10px", border: "1px solid var(--pd-border)" }}>
